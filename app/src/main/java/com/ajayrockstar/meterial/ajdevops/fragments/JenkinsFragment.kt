 ...
 * [JenkinsFragment.OnFragmentInteractionListener] interface
...
class JenkinsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        return inflater!!.inflate(R.layout.fragment_jenkins, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): JenkinsFragment {
            val fragment = JenkinsFragment()
            val args = Bundle()
